...
const CoordinateFacultySignup = () =>{
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            const response = await axios.post(`${BASE_URL}/api/signup/faculty`,formValues);
            console.log("response")
            if(response.data)
            {
                toast.success("SignUp is Successful")
                dispatch(authenticate(true));
                navigate('/login/co-faculty');
            }
        }catch(error)
        {
...
export default CoordinateFacultySignup;