            ...
            <div className="max-w-6xl mx-auto mt-10 p-6 bg-white shadow-md rounded-md">
                ...
                <div className="space-y-4">
                    {/* <div className="p-4 border rounded-md shadow-sm">
                        <h3 className="text-xl font-bold">Image Submissions</h3>
                        <p>Total Records: {progressData.imageSubmission}</p>
                    </div> */}
                    <div className="p-4 border rounded-md shadow-sm">
                        <h3 className="text-xl font-bold">Faculty Achievements</h3>
                        <p>Total Records: {progressData.facultyAchievement}</p>
                    </div>
                    {/* Add other tables similarly */}
                </div>
            </div>
