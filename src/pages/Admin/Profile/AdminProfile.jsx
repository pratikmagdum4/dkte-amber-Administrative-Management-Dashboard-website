...
const ProfileDetailsForm = () => {
    const adminId = useSelector(selectCurrentUid);
    ...
    useEffect(() => {
        const fetchAdminData = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/api/data/admin/${adminId}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`${BASE_URL}/api/data/admin/${adminId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
...
const UpdateIDCard = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${BASE_URL}/api/v1/auth/admin/${adminId}/upload`, {
                method: 'PATCH',
                headers: {
                    Authorization: `Bearer ${token}`
                },
