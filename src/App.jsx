  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/login/clerk/deptlist/deptlogin/home/studentachievement/course-list/diploma/year1' element={<PrivateRoute element={<FirstYearDiplomaTables />} allowedRoles={["clerk"]} />} />
